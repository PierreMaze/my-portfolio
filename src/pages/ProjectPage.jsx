      ...
      <div className="flex-1">
        {previous ? (
          <button
            ...
            className="flex items-center gap-3 transition-colors text-zinc-600 hover:text-orange-600 group">
    ...
    <div className="flex flex-wrap gap-4">
      {github && (
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-colors bg-zinc-800 hover:bg-zinc-700">
      ...
      {demo && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-colors bg-orange-600 hover:bg-orange-700">
          <svg
            className="w-4 h-4"
            fill="none"
            stroke="currentColor"
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <FadeIn className="delay-300">
              <section>
                <StacksTagsList stacks={project.tags} />
              </section>
            </FadeIn>
